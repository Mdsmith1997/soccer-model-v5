...
OUTPUT_BOOKS = (
    ...
    / "data"
    / "processed"
    / "over25_remaining3_t24_bookmakers.csv"
)
...
LEAGUES = {
    "Segunda División": {
        ...
        "cache_slug": "segunda_division",
    },
    "Super Lig": {
        "sport_key": "soccer_turkey_super_league",
        "cache_slug": "super_lig",
    },
    "Swiss Super League": {
        "sport_key": "soccer_switzerland_superleague",
        "cache_slug": "swiss_super_league",
    },
}
...
def normalize_text(value):
    ...
    # Turkish dotless i does not decompose to ASCII under NFKD.
    # Convert explicitly before ASCII cleanup.
...
ALIASES = {
    ...
    # FootyStats / Odds API deterministic aliases
    # ========================================================
    ...
    "grasshopper": "grasshopper zurich",
    ...
    # ========================================================
    # Turkish Super Lig
    # Final Super Lig alias recovery
    ...
    "gaziantep fk": "gazisehir gaziantep",
    ...
    "konyaspor": "torku konyaspor",
    "torku konyaspor": "torku konyaspor",
...
def main():
    ...
    missing_path = (
        ...
        / "data"
        / "processed"
        / "serie_a_under11_t24_missing.csv"
    )
