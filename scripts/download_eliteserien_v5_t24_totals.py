...
OUTPUT_BOOKS = (
    ...
    / "data"
    / "processed"
    / "eliteserien_v5_t24_totals_bookmakers.csv"
)
...
OUTPUT_GAMES = (
    ...
    / "data"
    / "processed"
    / "eliteserien_v5_t24_totals_games.csv"
)
...
def main():
    ...
    print("=" * 120)
    print(
        "ELITESERIEN V5 — FULL HISTORICAL T-24H TOTALS DOWNLOAD"
    )
    print("=" * 120)
    ...
    print("=" * 120)
    print(
        "ELITESERIEN T-24 TOTALS DOWNLOAD SUMMARY"
    )
    print("=" * 120)
