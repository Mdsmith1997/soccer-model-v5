...
def main():
    print()
    print("=" * 120)
    print("BELGIAN PRO LEAGUE V5 — OVER 2.5 SPECIALIST DISCOVERY")
    print("=" * 120)
    ...
    # Same Poisson/V5 total probability used by the
    # original Belgian test, simply evaluated on OVER.
    ...
    print()
    print("=" * 120)
    print("OVER 2.5 — THRESHOLD SWEEP")
    print("=" * 120)

    # Wider discovery sweep than the old frozen Under test.
    thresholds = [
        .03, .04, .05, .06, .07, .08,
    ...
    for threshold in thresholds:
        print_result(
            f">={threshold:.0%}",
            performance(merged, threshold),
        )

    print()
    print("=" * 120)
    print("OVER 2.5 — SEASON STABILITY")
    print("=" * 120)

    for threshold in thresholds:
        print()
        print(f"OVER >= {threshold:.0%} EDGE")
    ...
    print()
    print("=" * 120)
    print("OVER 2.5 — NON-OVERLAPPING EDGE BANDS")
    print("=" * 120)
    ...
    print()
    print("=" * 120)
    print("OVER 2.5 — LEAVE-ONE-SEASON-OUT BY THRESHOLD")
    print("=" * 120)

    seasons = sorted(
        merged["season"].dropna().unique()
    )
