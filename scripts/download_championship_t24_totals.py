...
OUTPUT_BOOKS = (
    ...
    / "data"
    / "processed"
    / "championship_under11_t24_bookmakers.csv"
)
...
OUTPUT_GAMES = (
    ...
    / "data"
    / "processed"
    / "championship_under11_t24_games.csv"
)

LEAGUES = {
    "Championship": {
        "sport_key": "soccer_efl_champ",
        "cache_slug": "championship",
    },
}
...
def main():
    ...
    missing_path = (
        ...
        / "data"
        / "processed"
        / "championship_under11_t24_missing.csv"
    )
